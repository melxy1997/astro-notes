...
# AstroNotes Template Documentation

![AstroNotes](https://github.com/user-attachments/assets/ae539704-2292-492f-882c-c90595b34717)
...
1. **📦 Installation**
   ...
   ### 🚀**Astro Installation**
   ```bash
   npm create astro@latest -- --template Melxy1997/AstroNotes
   ```
   or
   ### 🔧**Manual Installation**
   ...
   #### Clone Repository
   ```bash
   git clone https://github.com/Melxy1997/AstroNotes.git
   ```
